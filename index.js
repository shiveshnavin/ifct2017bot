...
X.all('/fn/sql/:txt', (req, res, next) => inp.sql(db, req.params.txt, req.query).then(ans => res.json(ans), next));
X.all('/fn/slang/:txt', (req, res, next) => inp.slang(db, req.params.txt, req.query).then(ans => res.json(ans), next));
X.all('/fn/english/:txt', (req, res, next) => inp.english(db, req.params.txt, req.query).then(ans => res.json(ans), next));
